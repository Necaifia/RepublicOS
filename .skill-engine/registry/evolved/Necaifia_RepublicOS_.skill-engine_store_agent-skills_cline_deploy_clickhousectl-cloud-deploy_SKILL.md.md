---
description: Use when a user wants to deploy ClickHouse to the cloud, go to production,
  use ClickHouse Cloud, host a managed ClickHouse service, or migrate from a local
  ClickHouse setup to ClickHouse Cloud. Follows agent-native CI/CD with eval-gated
  promotion, canary rollouts, and compensating rollback actions.
license: Apache-2.0
metadata:
  author: ClickHouse Inc
  evolved: true
  evolved_at: '2026-07-20T14:07:05.389397+00:00'
  version: 0.2.0
