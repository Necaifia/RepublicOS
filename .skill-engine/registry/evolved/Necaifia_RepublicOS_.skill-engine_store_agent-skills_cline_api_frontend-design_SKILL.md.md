...
description: Guidance for distinctive, intentional visual design when building new
  ...
  making choices that don't read as templated defaults. Follows API design best practices
  with schema validation, error standardization, and idempotency support. Uses transactional
  safety with compensating actions, connection pooling, and query validation.
license: Complete terms in LICENSE.txt
metadata:
  evolved: true
  evolved_at: '2026-07-20T14:07:05.171865+00:00'
