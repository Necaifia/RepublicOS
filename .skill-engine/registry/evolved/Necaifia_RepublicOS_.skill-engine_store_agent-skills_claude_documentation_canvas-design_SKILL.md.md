...
description: Create beautiful visual art in .png and .pdf documents using design philosophy.
  ...
  work to avoid copyright violations. Follows documentation-as-code with structured
  templates, audience adaptation, and automated freshness checks.
license: Complete terms in LICENSE.txt
metadata:
  evolved: true
  evolved_at: '2026-07-20T14:07:04.926766+00:00'
name: canvas-design
tags:
- documentation
version: 2
