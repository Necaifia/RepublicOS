...
description: Suite of tools for creating elaborate, multi-component claude.ai HTML
  ...
  - not for simple single-file HTML/JSX artifacts. Follows current best practices
  for reliability, security, and maintainability. Enforces least-privilege, secret
  management, input validation, and audit logging throughout.
license: Complete terms in LICENSE.txt
metadata:
  evolved: true
  evolved_at: '2026-07-20T14:07:05.147307+00:00'
