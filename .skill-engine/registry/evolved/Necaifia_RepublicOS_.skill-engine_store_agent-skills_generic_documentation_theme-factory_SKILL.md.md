...
description: Toolkit for styling artifacts with a theme. These artifacts can be slides,
  ...
  theme on-the-fly. Follows documentation-as-code with structured templates, audience
  adaptation, and automated freshness checks.
license: Complete terms in LICENSE.txt
metadata:
  evolved: true
  evolved_at: '2026-07-20T14:07:05.909400+00:00'
name: theme-factory
tags:
- documentation
- utility
