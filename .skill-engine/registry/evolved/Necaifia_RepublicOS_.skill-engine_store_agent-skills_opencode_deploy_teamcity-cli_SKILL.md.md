---
description: Use when working with TeamCity CI/CD or when a user provides a TeamCity
  build URL — drives the `teamcity` CLI for builds, logs, jobs, queues, agents, pools,
  projects, and pipelines. Follows agent-native CI/CD with eval-gated promotion, canary
  rollouts, and compensating rollback actions.
metadata:
  evolved: true
  evolved_at: '2026-07-20T14:07:06.283116+00:00'
name: teamcity-cli
tags:
- deploy
version: 1.0.0
