...
description: 'Build and deploy full-stack web and mobile apps with AWS Amplify Gen2
  ...
  (use aws-serverless), direct Bedrock without Amplify AI Kit (use bedrock). Follows
  agent-native CI/CD with eval-gated promotion, canary rollouts, and compensating
  rollback actions.'
metadata:
  evolved: true
  evolved_at: '2026-07-20T14:07:05.846418+00:00'
