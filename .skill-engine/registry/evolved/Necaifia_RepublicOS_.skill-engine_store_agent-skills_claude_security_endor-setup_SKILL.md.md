---
description: Use when user asks to setup endorctl, install endorctl, run endorctl
  scan, scan for vulnerabilities, run endor scan or run Endor Labs scan or when any
...
metadata:
  evolved: true
  evolved_at: '2026-07-20T14:07:05.007400+00:00'
name: endor-setup
tags:
- security
version: 2
