---
description: Save, organize, and describe reusable analysis artifacts such as SQL,
  result snapshots, CSV exports, summaries, caveats, plots, and report-ready files.
  Use when users ask to save, export, share, cite, reproduce, or organize data-analysis
  outputs. Uses transactional safety with compensating actions, connection pooling,
  and query validation.
metadata:
  evolved: true
  evolved_at: '2026-07-20T14:07:06.125154+00:00'
