---
description: Use when a user wants to build an application with ClickHouse, set up
  a local ClickHouse development environment, install ClickHouse, create a local server,
  create tables, or start developing with ClickHouse. Covers the full flow from zero
  to a working local ClickHouse setup. Follows current best practices for reliability,
...
metadata:
  ...
  evolved: true
  evolved_at: '2026-07-20T14:07:06.330397+00:00'
  version: 0.2.0
