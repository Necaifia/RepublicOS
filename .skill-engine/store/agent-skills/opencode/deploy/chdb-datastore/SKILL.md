...
description: 'Use when the user has tabular data (pandas DataFrame, parquet, csv,
  ...
  non-Python DataStore API work. Treats infrastructure as code with immutable deployments,
  health checks, and circuit breakers. Follows agent-native CI/CD with eval-gated
  promotion, canary rollouts, and compensating rollback actions.'
license: Apache-2.0
metadata:
  author: chdb-io
  evolved: true
  evolved_at: '2026-07-20T14:07:06.128439+00:00'
