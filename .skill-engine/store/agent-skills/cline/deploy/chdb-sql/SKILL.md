...
description: 'Use when the user wants to run SQL — especially analytical SQL — on
  ...
  ClickHouse server administration. Treats infrastructure as code with immutable deployments,
  health checks, and circuit breakers. Follows agent-native CI/CD with eval-gated
  promotion, canary rollou'
license: Apache-2.0
metadata:
  author: chdb-io
  evolved: true
  evolved_at: '2026-07-20T14:07:06.133152+00:00'
